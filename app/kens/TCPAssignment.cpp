...
//           prepare_buffer(new_sock_info, arrived_packet);
...
//         int read_byte = read_data(blocked_read->usr_buffer, self_sock_info, blocked_read->read_byte);
//         this->returnSystemCall(blocked_read->uuid, blocked_read->read_byte);
